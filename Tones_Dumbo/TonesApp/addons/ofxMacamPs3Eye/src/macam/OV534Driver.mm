...
- (void) initCamera
{
    ...
    [self setSensorRegister:0x13 toValue:0xf0];//SCOTT changed in attempt to disable auto def 0xf0
    [self setSensorRegister:0x0d toValue:0x41];
    ...
    [self setSensorRegister:0x64 toValue:0xff];//SCOTT changed in attempt to disable default: 0xff
    [self setSensorRegister:0x0d toValue:0x41];
